...
/* To Run the code First run createNewDatabase() that time other function comment.
same as for other operation.*/
...
/* Before run the code 
-->You have to install mongodb library,  command is "npm install mongodb" */
